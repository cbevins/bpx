...
function createNodes() {
  var nodes = new Dag( null, 'nodes', 'Variants' )
    ...
    var ftime = new Dag( nodes, 'ftime', 'Time' )
  ...
  Vapply( sf1f, 'dist', vt.fire.dist, '',
    lib.math.mul2, [ sf1f.ros, ftime.etig ] )

  Vapply( sf1f, 'mdist', vt.fire.mdist, '',
    lib.math.div2, [ sf1f.dist, map.scl ] )
  ...
  Vapply( sf2f, 'dist', vt.fire.dist, '',
    lib.math.mul2, [ sf2f.ros, ftime.etig ] )

  Vapply( sf2f, 'mdist', vt.fire.mdist, '',
    lib.math.div2, [ sf2f.dist, map.scl ] )
