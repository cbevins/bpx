...
function test1() {
  ...
  dag.setConfigs( [
    ...
    [ cfg.crown.fli, 'surface' ],   // 'surface', 'fl', 'fli
  ...
  if ( testFireEllipse ) {
    debug.addTests( [
      ...
      // beta and psi
      [ w.nodes.slp.dir.asp, 0, 180.0, allow09 ],
      [ w.nodes.slp.dir.up, 0, 0.0, allow09 ],
      [ w.nodes.fire.vec.beta.azno, 0, 45.0, allow09 ],
      [ w.nodes.fire.vec.beta.azup, 0, 45.0, allow09 ],
      [ w.nodes.fire.vec.beta.azhd, 0, 360. - 42.573367385837855, allow09 ],
  ...
  dag.setInputs( [
    [ w.nodes.surf.fuel.sf1.modl.key, ['10', '124'] ],
    ...
    [ w.nodes.surf.fuel.sf1.bed.char.mwsp, [880.] ],
    [ w.nodes.fire.time.etig, [60.0] ],
    [ w.nodes.map.scl, [24000.0] ],
    [ w.nodes.fire.vec.beta.azno, [45.0] ],
    [ w.nodes.fire.vec.psi.azno, [45.0] ],
  ])
