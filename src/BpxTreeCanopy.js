...
export default class BpxTreeCanopy extends DagBranch {
  ...
  connect( /*tree */) {
    ...
    this.crownLength.calc(BpxLibCanopy.crownLength, this.crownBase, this.crownHeight);
    this.crownRatio.calc(BpxLibCanopy.crownRatio, this.crownLength, this.crownHeight);
    this.crownFill.calc(BpxLibCanopy.crownFill, this.cover, this.crownRatio);
