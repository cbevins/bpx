 ...
 */
test('1: Crown fire using the Benchmark124 surface fire', () => {
  ...
  expect(approx(primary.fire.heatPerUnitArea.value(), 12976.692888496578 * 0.23541979977677915)).toEqual(true);
  ...
  expect(approx(tree.crown.fire.active.powerRatio.value(), 139.615140469098 / 47.96568165233)).toEqual(true);
